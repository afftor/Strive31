...
func _on_sexual_visibility_changed():
	...
	if slave.consent == false:
		get_node("hidingpanel").visible = true
		...
		get_node("hidingpanel").visible = false
	...
	get_node("descriptpanel").visible = false
...
func _on_group_pressed():
	...
	get_node("group/grouppopup/Panel/partner2").visible = false
...
func groupcheck(slave2 = null):
	...
	if get_node("group/grouppopup/Panel/threesome").is_pressed() == true:
		get_node("group/grouppopup/Panel/partner2").visible = true
...
func _on_close_pressed():
	get_node("group/grouppopup").visible = false
	get_node("group/grouppopup/Panel/orgy").set_pressed(false)
	get_node("group/grouppopup/Panel/threesome").set_pressed(false)
...
func _on_piercing_pressed():
	get_node("piercingpanel").visible = true
...
func _on_closebutton_pressed():
	get_node("unlockbutton/unlockpopup").visible = false
