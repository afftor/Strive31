...
var dict = {
	...
	foodcapacity = {
		...
		code = 'foodcapacity',
		description = "Adds additional space to the food storage area allowing you to store more food.", 
		levels = 5,
	...
	mansionkennels = {
		name = "Kennels",
		code = 'mansionkennels',
		description = "Builds a kennel on the mansion’s grounds providing space to keep hounds. Having hounds on the property reduces the chances of slaves escaping during the night, and for those so inclined unlocks the bestiality action. ", 
		levels = 1,
		pointscost = 15,
		cost = 1500,
	},
